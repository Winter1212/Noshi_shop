<?php
session_start();
define("APPURL", "http://localhost/Noshi");
                ...
                <div class="collapse navbar-collapse" id="navbarcollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if (!isset($_SESSION["username"])): ?>
                            <li class="nav-item">
                                <a href="http://localhost/Noshi/auth/register.php" class="nav-link">Register</a>
                            </li>
                            <li class="nav-item">
                                <a href="http://localhost/Noshi/auth/login.php" class="nav-link">Login</a>
                            </li>
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <div class="avatar-header"><img src="<?php echo APPURL; ?>/assets/img/logo/<?php echo $_SESSION['image'];?>">
                                    </div> <?php echo $_SESSION['username']; ?>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo APPURL; ?>/transaction.php">Transactions
                                        History</a>
                                    <a class="dropdown-item" href="<?php echo APPURL; ?>/setting.php">Settings</a>
                                    <a class="dropdown-item" href="http://localhost/Noshi/auth/logout.php">Log out</a>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo APPURL; ?>/products/cart.php" class="nav-link" data-toggle="" aria-haspopup="true"
                                    aria-expanded="false">
